<?php
session_start();
$dbconn = pg_connect("host=localhost port=5432 dbname=Intersection user=postgres password=BIAR")  or header("Location: ../Errore/index.php?er=100");
?>
...
<body>
    ...
    else
    {
        ...
        {
          header("Location: ../Errore/index.php?er=1");
        }
        else
        {
            $user=$_POST['username'];
            ...
            {
              header("Location: ../Errore/index.php?er=2");
            }  
            else
            {
                ...
                {
                  header("Location: ../Errore/index.php?er=3");
                }
                else
                {
                  ...
                  {
                    header("Location: ../Errore/index.php?er=4");
                  }
                  else
                  {
