              ...
              <?php 
                if( !isset( $_GET["sa"] ) || !isset( $_GET["uid"] )) :
                  ...
                  if( $_GET["sa"] == 0 ) :
                    ...
                    $result = pg_query_params( $dbconn, $query, array($uid) );
                    if( pg_num_rows( $result ) == 0 ) {
                      echo '<div class="text-center bg-warning-subtle border border-warning p-5 rounded">User not found</div>';
                    } else {
                      $line = pg_fetch_assoc( $result );
                      $nome = $line["name"];
                      $cognome = $line["surname"];
                      ...
                      <div class="d-flex flex-column gap-4">
                        <div class="dettagli-professionista">
                          ...
                          <div class="user-email"><span class="fw-bold">Contact Email:</span> <span><a href=" <?php echo 'mailto:' . $contact_email ?> " class="text-decoration-none text-color-1 fw-bold"><?php echo $contact_email ?></a></span></div>
                          <div class="user-phone"><span class="fw-bold">Phone number:</span> <span><a href=" <?php echo 'tel:' . $telephone_number ?> " class="text-decoration-none text-color-1 fw-bold"><?php echo $telephone_number ?></a></span></div>
                        </div>
                        <div class="curriculum">
                          <div class="fw-bold fs-5 mb-2">Curriculum Vitae</div>
                          <object data=" <?php echo $filename_curriculum ?> " type="application/pdf" width="100%" height="600px" class="rounded">
                            <p>Unable to show PDF file directly in browser. <a href=" <?php echo $filename_curriculum ?> ">Download</a> the file.</p>
                          </object>
                        </div>
                      </div>
                      <?php 
                  ...
                  elseif( $_GET["sa"] == 1 ):
                    ...
                    if( pg_num_rows( $result ) == 0 ) {
                      ...
                      <div class="d-flex flex-column gap-4">
                        <div class="dettagli-professionista">
                          <div class="fw-bold fs-5 mb-2">Details</div>
                          <div class="user-birthday"><span class="fw-bold">VAT number:</span> <span><?php echo $vat_number ?></span></div>
                          <div class="user-address"><span class="fw-bold">Address:</span> <span><?php echo $address ?></span></div>
                          <div class="user-city"><span class="fw-bold">City:</span> <span><?php echo $city ?></span></div>
                          <div class="user-country"><span class="fw-bold">Country:</span> <span><?php echo $country ?></span></div>
                          <div class="user-email"><span class="fw-bold">Contact Email:</span> <span><a href=" <?php echo 'mailto:' . $contact_email ?> " class="text-decoration-none text-color-1 fw-bold"><?php echo $contact_email ?></a></span></div>
                          <div class="user-phone"><span class="fw-bold">Phone number:</span> <span><a href=" <?php echo 'tel:' . $telephone_number ?> " class="text-decoration-none text-color-1 fw-bold"><?php echo $telephone_number ?></a></span></div>
                        </div>
                      </div>
