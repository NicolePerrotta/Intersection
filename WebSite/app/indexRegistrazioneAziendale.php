...
<!--BODY-->
      ...
      <div id="content"> 
      <form name="formRegistrazioneAziendale" action="../app/RegistrazioneAzienda.php" method="POST" class="form-signin bg-light" id="form-registrazione" onSubmit="return validaRegistrazioneAziendale()">
