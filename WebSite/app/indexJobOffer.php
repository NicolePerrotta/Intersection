          ...
          <?php 
            ...
            while ($line=pg_fetch_array($result, null, PGSQL_ASSOC)) 
            {
              ...
              echo'             
                        ...
                        {
                          echo "<div class='group-bottoni'><a href='indexInfoJobOffer.php?offer_id=".$offer_id."'><button class='btn black-button shadow-none'><i class='fa-solid fa-circle-plus'></i> Details</button></a><br>";
                          echo "</div>";
                        }
                       echo      '
                  </div> <br>';
