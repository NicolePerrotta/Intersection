...
<!DOCTYPE html>
  <html>
    ...
    <head>
      ...
      <title>
        <?php 
          if( $_SESSION['lang'] == 'it' ) { echo "Errore - Intersection"; }
          if( $_SESSION['lang'] == 'en' ) { echo "Error - Intersection"; }
        ?>
      </title>
            ...
            <div class="dropdown">
              <button class="btn dropdown-toggle fw-bold" type="button" data-bs-toggle="dropdown" aria-expanded="false" style="border: none;">IT</button>
                <ul class="dropdown-menu dropdown-menu-end" style="--bs-dropdown-min-width: 10px; --bs-dropdown-bg: #F9FBFE; --bs-dropdown-link-hover-color: var(--intersection-color-3); --bs-dropdown-link-active-color: var(--intersection-color-3); --bs-dropdown-link-active-bg: transparent; transition: none;">
                  ...
                  <li><a class="dropdown-item" href="indexErrore.php?lang=it">Italiano</a></li>
                  <li><a class="dropdown-item" href="indexErrore.php?lang=en">English</a></li>
                </ul>
            </div>
        ...
        <section id="login">
          <div class="container px-3" style="padding: 120px 0;">
            <div class="col-md-8 mx-auto d-flex flex-column align-items-center gap-5">
              <?php 
                if( !isset( $_GET['er'] ) ) {
                  $err_msg = "Something went wrong, we are working to fix it.";
                } else {
                  switch( $_GET['er'] ) {
                    case 1:
                      $err_msg = "Your email is already associated with a registered user.";
                      break;
                    case 2:
                      $err_msg = "Your username is already associated with a registered user.";
                      break;
                    case 3:
                      $err_msg = "Your password is already associated with a registered user.";
                      break;
                    case 4:
                      $err_msg = "Your VAT number is already associated with a registered user.";
                      break;
                    case 8:
                      $err_msg = "Your email is not associated with a registered user.";
                      break;
                    case 9:
                      $err_msg = "Your password appears to be incorrect.";
                      break;
                    default:
                      $err_msg = "Something went wrong, we are working to fix it.";
                      break;
