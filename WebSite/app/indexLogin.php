          ...
          <div class="container px-3" style="padding: 120px 0;">
            <div class="col-md-8 mx-auto d-flex flex-column gap-5">
              ...
              <div class="d-flex flex-column gap-3">
                ...
                <div class="text-color-5 text-center">Non hai ancora un account? Registrati come <a href="../app/indexRegistrazione.php" class="text-decoration-none text-color-2 fw-bold">professionista</a> o come <a href="../app/indexRegistrazioneAziendale.php" class="text-decoration-none text-color-2 fw-bold">azienda</a>.</div>
              </div>
            </div>
          </div>
        </section>
