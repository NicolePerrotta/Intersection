          ...
          <div class="container px-3" style="padding: 140px 0 100px 0;">
            <div class="d-flex flex-column-reverse flex-lg-row align-items-center gap-5">
              ...
              <?php else : ?>
                <h2 class="text-color-2 fw-bold fs-1">Sei un'azienda.</h2>
                <p class="text-color-5" style="font-size: 24px;">Carica la tua offerta di lavoro e scopri qual è il candidato perfetto per te grazie al nostro algoritmo di Intelligenza Artificiale!</p>
                <a href=" <?php echo '../app/indexJobOffers.php?uid=' . $_SESSION['uid'] . '&sa=' . $_SESSION['sa'] ?> " class="text-color-3 text-decoration-none fw-bold py-2 px-3 border border-2 rounded" style="border-color: var(--intersection-color-3) !important; width: fit-content;">Vai alle offerte di lavoro pubblicate</a>
              <?php endif; ?>
              </div>
            </div>
          </div>
          ...
          <div class="container px-3" style="padding: 100px 0;">
            <div class="d-flex flex-column-reverse flex-lg-row-reverse align-items-center gap-5">
              ...
              <?php if( !isset( $_SESSION['uid'] ) || !isset( $_SESSION['sa'] ) ) : ?>
                ...
                <a href=" <?php echo '../app/indexRegistrazione.php' ?> " class="text-color-3 text-decoration-none fw-bold py-2 px-3 border border-2 rounded" style="border-color: var(--intersection-color-3) !important; width: fit-content;">Registrati come professionista</a>
              <?php else : ?>
                <h2 class="text-color-2 fw-bold fs-1">Sei un professionista.</h2>
                <p class="text-color-5" style="font-size: 24px;">Carica il tuo curriculum: penseremo noi a tutto il resto con il nostro algoritmo di Intelligenza Artificiale!</p>
                <a href=" <?php echo '../app/indexListJobs.php?uid=' . $_SESSION['uid'] . '&sa=' . $_SESSION['sa'] ?> " class="text-color-3 text-decoration-none fw-bold py-2 px-3 border border-2 rounded" style="border-color: var(--intersection-color-3) !important; width: fit-content;">Vai alle offerte di lavoro selezionate per te</a>
              <?php endif; ?>
              </div>
            </div>
          </div>
