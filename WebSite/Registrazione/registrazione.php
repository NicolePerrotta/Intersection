...
<!DOCTYPE html>
  ...
  <script>
    ...
    <div id="content">
    <form action="../PHP/RegistrazioneUtente.php" class="form-signin bg-light" method="POST" name="formRegistrazione" id="form-registrazione" onSubmit="return validaRegistrazione()">
